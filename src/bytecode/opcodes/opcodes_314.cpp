...
const insn_def table_314[] = {
    ...
    {   4, "CALL_FUNCTION_EX",     op::none,      -1, F::flag_call | F::flag_cache, 1 },
    {   5, "CHECK_EG_MATCH",       op::none,       0, F::flag_except, 0 },
    {   6, "CHECK_EXC_MATCH",      op::none,      -1, F::flag_except, 0 },
    {   7, "CLEANUP_THROW",        op::none,      -2, F::flag_except, 0 },
    ...
    {  20, "INTERPRETER_EXIT",     op::none,       0, F::flag_stop, 0 },
    {  21, "LOAD_BUILD_CLASS",     op::none,       1, F::flag_push, 0 },
    {  22, "LOAD_LOCALS",          op::none,       1, F::flag_push, 0 },
    {  23, "MAKE_FUNCTION",        op::none,       0, F::flag_none, 0 },
    ...
    {  28, "NOT_TAKEN",            op::none,       0, F::flag_none, 0 },
    ...
    {  34, "RETURN_GENERATOR",     op::none,       0, F::flag_ret, 0 },
    ...
    {  44, "BINARY_OP",            op::byte,      -1, F::flag_cache, 5 },
    ...
    {  81, "LOAD_COMMON_CONSTANT", op::byte,       1, F::flag_load | F::flag_push, 0 },
    ...
    {  89, "LOAD_FAST_LOAD_FAST",  op::byte,       2, F::flag_load | F::flag_push, 0 },
    ...
    { 113, "STORE_FAST_LOAD_FAST", op::byte,       0, F::flag_store | F::flag_load, 0 },
    { 114, "STORE_FAST_STORE_FAST", op::byte,     -2, F::flag_store, 0 },
